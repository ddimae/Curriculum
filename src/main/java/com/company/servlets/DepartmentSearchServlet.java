...
@WebServlet(urlPatterns = {"/searchDepartment"})
public class DepartmentSearchServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                list1 = MyUtils.searchDepartments(conn, search);
                list = MyUtils.searchDepartmentsPage(conn, search, (page - 1) * recordsPerPage, recordsPerPage);
