...
@WebServlet(urlPatterns = {"/DisciplineList"})
public class DisciplineListServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    public DisciplineListServlet() {
        super();
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                list1 = MyUtils.listDisciplines(conn);
                list = MyUtils.listDisciplinesPage(conn, (page - 1) * recordsPerPage, recordsPerPage);
