...
@WebServlet(urlPatterns = { "/deleteDiscipline" })
public class DisciplineDeleteServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;
 
    public DisciplineDeleteServlet() {
        super();
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
	        ...
	        try {
	            MyUtils.deleteDiscipline(conn, id);
	        ...
	        if (errorString != null) {
	            ...
	            RequestDispatcher dispatcher = request.getServletContext()
	                    .getRequestDispatcher("/WEB-INF/views/DisciplineDeleteView.jsp");
