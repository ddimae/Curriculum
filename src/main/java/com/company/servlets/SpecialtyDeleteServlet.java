...
@WebServlet(urlPatterns = { "/deleteSpecialty" })
public class SpecialtyDeleteServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;
 
    public SpecialtyDeleteServlet() {
        super();
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
	        ...
	        try {
	            MyUtils.deleteSpecialty(conn, id);
	        ...
	        if (errorString != null) {
	            ...
	            RequestDispatcher dispatcher = request.getServletContext()
	                    .getRequestDispatcher("/WEB-INF/views/SpecialtyDeleteView.jsp");
